...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Integer> findBookByBorrowmemnoExists(){
        return bookRepository.findBookByBorrowmemnoExists();
    }

    @Override
    public Integer CountBooksByCallnumber(){
        return bookRepository.CountBooksByCallnumber();
    }

    @Override
    public List<String> findCallnumberByBookSum(){
        return bookRepository.findCallnumberByBookSum();
    }
