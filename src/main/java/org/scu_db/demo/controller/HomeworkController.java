...
public class HomeworkController {
    ...
    public List<Integer> homework1(){
        ...
        bookId = bookService.findBookByBorrowmemnoExists();
    ...
    public List<Title> homework2(){
        ...
        titles = titleService.findBooksByName();
    ...
    public Integer homework3(){
        ...
        count=bookService.CountBooksByCallnumber();
    ...
    public List<String> homework4(){
        ...
        callnumbers = bookService.findCallnumberByBookSum();
